    ...
    <body>
        ...
        <div class="text-center mt-4 container">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Administrar revisores</li>
                </ol>
            </nav>
            <div class="pricing-header mb-4 text-center animate-opacity container">
                <h1 class="display-6">Administrar revisores</h1>
                <a class="btn btn-color-out btn-lg font-weight-bold mt-4" role="button" href="create">Agregar un nuevo revisor <img src="../svg/agregar.svg" height="35" alt="icon" loading="lazy"></a>    
            </div>
            ...
            <table id="example" class="table table-striped">
                <thead class="text-center">
                    <tr class="table-active">
                        ...
                        <th class="align-middle">Asignar libro</th>
                ...
                <tbody>
                    <s:iterator value="usuarios">
                        <tr class="align-middle"> 
                            ...
                            <td class="align-middle"><s:property value="correo"/></td>
                            ...
                            <td class="text-center">                                
                                <a class="btn btn-outline-success" href="asignarLibros?idRevisor=${idUsuario}&nombre=${nombre}" role="button" aria-pressed="true"> <img src="../svg/cheque.svg" width="35" height="35"> </a>
                            </td>
                            <td class="text-center">                                
                                <a class="btn btn-outline-success" href="asignarAlumnos?idRevisor=${idUsuario}&nombreRevisor=${nombre}" role="button" aria-pressed="true"> <img src="../svg/cheque.svg" width="35" height="35"> </a>
                            </td>
                        </tr>
                    </s:iterator>                  
                </tbody>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header bg-danger">
                        <h5 class="modal-title text-light" id="exampleModalCenterTitle"> Eliminar revisor </h5>
                    ...
                    <div class="row modal-body text-center">
                        ...
                        <div class="col-9 mt-3">
                            <p class="font-weight-bold">¿Desea eliminar al revisor "<span class="text-danger" id="titulo-in"></span>"?<br></p>
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                $('#example').DataTable({
                    "oLanguage": {
                        "sSearch": '<a class="btn btn-lg searchBtn color-text" id="searchBtn"><b>Buscar revisor<img src="../svg/buscar.svg" width="30" height="30"></b></a>',
