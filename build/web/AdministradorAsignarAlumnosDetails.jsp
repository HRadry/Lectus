        ...
        <main role="main" class="inner cover container mt-4">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="asignarAlumnos">Asignar alumnos</a></li>
                ...
                <form>
                    <div class="row">
                        <div class="col-md-6 border-left">
                            <fieldset>
                                <legend class="font-weight-normal">Datos generales del alumno</legend>
                        ...
                        <div class="col-md-6 border-left mb-4">
                            ...
                            <div class="row no-gutters flex-md-row mb-4 position-relative box-book">
                                <div class="mt-2 d-flex flex-column position-static">
                                    ...
                                    <p class="mt-2 font-weight-bold">Numero telefónico: <span class="card-text font-weight-normal">9512569837.</span></p> 
                                    <p class="mt-2 font-weight-bold">Carrera: <span class="card-text font-weight-normal">${usuario.carrera}.</span></p>
                                    <p class="mt-2 font-weight-bold">Semestre: <span class="card-text font-weight-normal">${usuario.semestre}.</span></p>
                                    <p class="mt-2 font-weight-bold">Grupo: <span class="card-text font-weight-normal">${usuario.grupo}.</span></p>                                    
                    ...
                    <div class="text-center mt-2">                              
                        <a class="button btn btn-lg btn-color-out" href="asignarAlumnos" role="button"><i data-feather="arrow-left"></i> Regresar</a>                                                
                    </div>
                </form>                                                                
            </section>
        </main>
