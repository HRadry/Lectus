        ...
        <main role="main" class="inner cover container mt-4">            
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Entrega Reporte</li>
                </ol>
            </nav>
            <div class="pricing-header mb-5 text-center animate-opacity container">
                <h1 class="display-6">Entregar Reporte</h1>
                <s:actionerror />
            </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <table class="table table-bordered">
                                <thead>
                                <legend class="font-weight-normal">1.- Información de entrega</legend>
                                <br>
                                </thead>
                                <tbody>
                                    <tr>
                                        <th scope="row">Fecha de entrega</th>
                                        <td>Martes, 23 de Febrero del 2021, 23:00</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <th scope="row">Estatus de entrega</th>
                                        <td>No entregado</td>
                                    </tr>
                                    <tr>
                                        <th scope="row">Estatus de calificación</th>
                                        <td>Sin calificar</td>
                                    </tr>
                                </tbody>
                            </table>
                        ...
                        <div class="col-md-5">
                            <br>
                            <fieldset>
                                <legend class="font-weight-normal">2.- Cargar archivo  <img src="../svg/pdf.svg" height="30" alt="icon" loading="lazy"></legend>                                
                                <div class="form-group mt-2">                                   
                                    <label for="nameFile2" class="font-weight-bolder">Libro PDF</label>
                                    <div class="custom-file  border" id="customFile" style="border-radius:.3em">
                                        ...
                                        <label class="custom-file-label form-control-file" for="customFileLang" style="height:5px">Seleccionar archivo</label>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="sinopsis" class="font-weight-bolder">Comentarios</label>
                                <textarea class="form-control text-justify" id="word" name="sugerencia.sinopsis" rows="5" required maxlength="425" oninput="countWord()"></textarea>
                                <div class="invalid-feedback">
                                    Este campo es necesario 👆, por favor, acomplételo.
                                </div>
