...
<html lang="es">
    <head>
        ...
        <meta name="description" content="Panel para el revisor">        
        <title>Pandel del revisor</title>
        ...
        <main role="main">            
            <div class="container marketing mt-4">
                <div class="pricing-header mb-5 text-center animate-opacity container">
                    <h1 class="display-6">Panel del revisor</h1>
                </div>              
                <div class="row">
                    <div class="col-md-6 text-center mb-4">
                        <div class="card-body border rounded">
                            <img class="mb-4" src="../img/archive.svg" alt="" width="140" height="140">
                            <h2>Calificar reportes</h2>
                            <p class="mb-4">Califique los reportes de lecturas de los alumnos</p>
                            <!--<p><a class="btn btn-lg btn-color-out" href="/lectus/EntregaReporte/list" role="button">Calificar &raquo;</a></p>-->
                            <a class="button btn btn-lg btn-color-out" href="/lectus/reporte/list" role="button"><span>Calificar reportes</span> <i data-feather="arrow-right"></i></a>                                                 
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 text-center">
                        <div class="card-body border rounded">
                            ...
                            <a class="button btn btn-lg btn-color-out" href="/lectus/parcial/fechasRevisor" role="button"><span>Ver fechas</span> <i data-feather="arrow-right"></i></a>                                                 
                        </div>                        
                    </div>                                        
                </div>
