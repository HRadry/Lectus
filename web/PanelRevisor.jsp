...
<html lang="es">
    <head>
        ...
        <meta name="description" content="Panel del revisor">        
        <title>Panel del revisor</title>
        <!-- Bootstrap core CSS -->
            ...
            <div class="row justify-content-md-center">
                <div class="col-md-4">
                    <div class="card-body border-line-primary rounded mb-4">
                        <img class="mb-4" src="../svg/calificar.svg" alt="" width="140" height="140">
                        <h2>Calificar <br> reportes</h2>
                        <p class="mb-4">Califique los reportes de lecturas de los alumnos y añada comentarios.</p>
                        <a class="button btn btn-lg btn-out-secondary" href="/lectus/reporte/list" role="button"><span>Administrar</span> <i data-feather="arrow-right"></i></a>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="card-body border-line-primary rounded mb-4">
                        ...
                        <h2>Consultar <br> fechas</h2>
                        <p class="mb-4">Consulte las fechas de entrega de calificaciones de los reportes de lectura.</p>
