    ...
    <body>
        ...
        <div class="container mt-4 text-center">
            ...
            <div>
                ...
                <a class="btn btn-out-primary btn-lg font-weight-bold mt-4" role="button" href="create">Agregar nuevo revisor <img src="../svg/agregar.svg" height="35" alt="icon" loading="lazy"></a>    
            </div>
        </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="row modal-body text-center">
                        ...
                        <div class="col-8 mt-3">
                            <p>¿Desea eliminar el revisor <br>"<span class="font-weight-bold" id="titulo-in"></span>"?<br></p>
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                $('#example').DataTable({
                    "oLanguage": {
                        "sSearch": '<a class="btn btn-lg searchBtn color-text-primary" id="searchBtn"><b>Buscar revisor <img src="../svg/buscar.svg" width="30" height="30"></b></a>',
